...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Subscription', fields ['club', 'user']
        db.create_unique(u'registration_subscription', ['club_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subscription', fields ['club', 'user']
        db.delete_unique(u'registration_subscription', ['club_id', 'user_id'])
    ...
    models = {
        ...
        u'registration.subscription': {
            'Meta': {'unique_together': "(('club', 'user'),)", 'object_name': 'Subscription'},
        ...
        u'registration.user': {
            ...
            'subscribed_clubs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['clubreview.Club']", 'through': u"orm['registration.Subscription']", 'symmetrical': 'False'}),
