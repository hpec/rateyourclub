...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.permalink'
        db.add_column(u'clubreview_club', 'permalink',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Club.callink_permalink'
        db.alter_column(u'clubreview_club', 'callink_permalink', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
        # Adding index on 'Club', fields ['callink_permalink']
        db.create_index(u'clubreview_club', ['callink_permalink'])


    def backwards(self, orm):
        # Removing index on 'Club', fields ['callink_permalink']
        db.delete_index(u'clubreview_club', ['callink_permalink'])

        # Deleting field 'Club.permalink'
        db.delete_column(u'clubreview_club', 'permalink')


        # Changing field 'Club.callink_permalink'
        db.alter_column(u'clubreview_club', 'callink_permalink', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'clubreview.club': {
            ...
            'permalink': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'clubreview.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ratings': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        u'clubreview.school': {
