...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.SGID'
        db.add_column(u'clubreview_club', 'SGID',
                      self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Club.callink_permalink'
        db.add_column(u'clubreview_club', 'callink_permalink',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.SGID'
        db.delete_column(u'clubreview_club', 'SGID')

        # Deleting field 'Club.callink_permalink'
        db.delete_column(u'clubreview_club', 'callink_permalink')
