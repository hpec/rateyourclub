...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Club.review_score'
        db.add_column(u'clubreview_club', 'review_score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Club.review_score'
        db.delete_column(u'clubreview_club', 'review_score')
