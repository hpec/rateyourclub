...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Club.is_active'
        db.delete_column(u'clubreview_club', 'is_active')

        # Adding M2M table for field categories on 'Club'
        db.create_table(u'clubreview_club_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('club', models.ForeignKey(orm[u'clubreview.club'], null=False)),
            ('category', models.ForeignKey(orm[u'clubreview.category'], null=False))
        ))
        db.create_unique(u'clubreview_club_categories', ['club_id', 'category_id'])


    def backwards(self, orm):
        # Adding field 'Club.is_active'
        db.add_column(u'clubreview_club', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Removing M2M table for field categories on 'Club'
        db.delete_table('clubreview_club_categories')
