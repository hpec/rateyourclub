...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.is_deleted'
        db.add_column(u'clubreview_review', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.is_deleted'
        db.delete_column(u'clubreview_review', 'is_deleted')
