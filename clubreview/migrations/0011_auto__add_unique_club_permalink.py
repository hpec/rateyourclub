...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Club', fields ['permalink']
        db.create_unique(u'clubreview_club', ['permalink'])


    def backwards(self, orm):
        # Removing unique constraint on 'Club', fields ['permalink']
        db.delete_unique(u'clubreview_club', ['permalink'])
