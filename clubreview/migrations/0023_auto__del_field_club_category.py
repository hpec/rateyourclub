...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Club.category'
        db.delete_column(u'clubreview_club', 'category_id')


    def backwards(self, orm):
        # Adding field 'Club.category'
        db.add_column(u'clubreview_club', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clubreview.Category'], null=True),
                      keep_default=False)
