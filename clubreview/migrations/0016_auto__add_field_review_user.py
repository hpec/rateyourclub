...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'clubreview_review', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['registration.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.user'
        db.delete_column(u'clubreview_review', 'user_id')
