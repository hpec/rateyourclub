...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'clubreview_event', 'date')


    def backwards(self, orm):
        # Adding field 'Event.date'
        db.add_column(u'clubreview_event', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 30, 0, 0)),
                      keep_default=False)
